...
module.exports = {
  ...
  commands: [
    ...
    {
      name: 'torrent',
      description: 'Torrent episodi MLP'
    },
    {
      name: 'say',
  ...
  help: {
    ...
    user: {
      ...
      torrent: ['torrent', 'Torrent episodi MLP.'],
  ...
  manage_roles_permission_required: 'Chrysalis ha bisogno il permesso `Gestire i ruoli` da usare questo comando.',
  ...
  support_the_project: 'Supporta il progetto',
